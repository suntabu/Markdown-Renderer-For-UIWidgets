    ...
    public class SyntaxHighlighterStyle
    {
        ...
        public static SyntaxHighlighterStyle lightThemeStyle()
        {
            return new SyntaxHighlighterStyle(
                baseStyle: new TextStyle(color: new Color(0xFF000000), fontFamily: "monospace", fontSize: 14),
    ...
    public class DartSyntaxHighlighter : SyntaxHighlighter
    {
        ...
        public override TextSpan format(string src)
        {
            ...
            if (this._generateSpans())
            {
                ...
                {
//                    Debug.Log(
//                        this._src.Length + "   " + currentPosition + " -> " + (this._src.Length - currentPosition));
                    formattedText.Add(new TextSpan(text: this._src.substring(currentPosition,
                        this._src.Length)));
                }
    ...
    class _HighlightSpan
    {
        ...
        {
//            Debug.Log(src.Length + "   " + this.start + " -> " + this.end);
